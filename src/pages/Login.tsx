  ...
  return (
    <KeyboardAvoidingView style={{padding: 10, alignItems: 'center'}}>
      <View style={styles.container}>
        ...
        <Text style={styles.textServicos}>
          {' '}
          Serviços{'\n'}
          <Text style={styles.textPublicos}> Públicos</Text>
        </Text>
      </View>
      ...
      >
        <TextInput style={styles.inputUser} placeholder="Usuário" />
        <TextInput style={styles.inputPassword} secureTextEntry={true} placeholder="Senha" />
